...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!csrf_verify()) {
        ...
        $result = attempt_login($_POST['email'] ?? '', $_POST['password'] ?? '', 'student');
        if ($result === true) {
...
$pageTitle = 'Student Login — Elite Event';
...
<section class="auth-section">
  <div class="container auth-container">
    <div class="auth-card">
      <span class="auth-role-badge role-pill role-pill-student"><i class="ti ti-school"></i> Student Login</span>
      <h1>Welcome back, student 👋</h1>
      <p class="auth-sub">Log in to browse events and register for events.</p>
